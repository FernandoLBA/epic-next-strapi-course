...
export default function ProfileForm({
    ...
    // * Otra forma de enviar el id, es mediante un bind para agregar la data al action
        ...
        <form
            ...
            <div className="space-y-4 grid ">
                <div className="grid grid-cols-3 gap-4">
                    ...
                    {/* Este input almacena el id del usuario con la finalidad de enviar el id en el formData,
                    sin embargo este input no se muestra, porque no es necesario */}
